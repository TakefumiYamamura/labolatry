...
FILE *fp_val, *fp_val_length, *fp_fitness;
  ...
  sprintf(fname2, "../distance_to_centroid_de_wo_archive/func%d_P%d_D%d_%dth.csv",g_function_number, g_pop_size, problem_size, g_th_num);
  // sprintf(fname2, "../csvs_length_de_with_archive_D%d/func%d_%dth.csv", problem_size, g_pop_size, g_function_number, g_th_num);
  sprintf(fname3, "../fitness_de_wo_archive/func%d_P%d_D%d_%dth.csv",g_function_number, g_pop_size, problem_size, g_th_num);
