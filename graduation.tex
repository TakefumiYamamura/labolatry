...
表？では適応度$f(x)$を用いて，多様性を計測した．ある世代tの解集団$P = {x_{t,1}, \cdots, x_{t,N}}$の $x_{t,k}$を評価関数であるスフィア関数で評価した値$f(s_{t,k})$の標準偏差について，51回の試行の平均値を載せたのが〜である．
...
\begin{figure}[htbp]
  \begin{center}
    \begin{tabular}{c}
      ...
      \begin{minipage}{0.33\hsize}
        \begin{center}
          \includegraphics[clip, width=4.5cm]{P10D2.eps}
      ...
      \begin{minipage}{0.33\hsize}
        \begin{center}
          \includegraphics[clip, width=4.5cm]{P30D2.eps}
      ...
      \begin{minipage}{0.33\hsize}
        \begin{center}
          \includegraphics[clip, width=4.5cm]{P50D2.eps}
  ...
  \begin{center}
    \begin{tabular}{c}
      ...
      \begin{minipage}{0.33\hsize}
        \begin{center}
          \includegraphics[clip, width=4.5cm]{P10D10.eps}
      ...
      \begin{minipage}{0.33\hsize}
        \begin{center}
          \includegraphics[clip, width=4.5cm]{P30D10.eps}
      ...
      \begin{minipage}{0.33\hsize}
        \begin{center}
          \includegraphics[clip, width=4.5cm]{P50D10.eps}
          \hspace{1.2cm} [6] P=50, D=50
        \end{center}
      \end{minipage}
    \end{tabular}
  \end{center}
  \begin{center}
    \begin{tabular}{c}
      ...
      \begin{minipage}{0.33\hsize}
        \begin{center}
          \includegraphics[clip, width=4.5cm]{P10D30.eps}
      ...
      \begin{minipage}{0.33\hsize}
        \begin{center}
          \includegraphics[clip, width=4.5cm]{P30D30.eps}
      ...
      \begin{minipage}{0.33\hsize}
        \begin{center}
          \includegraphics[clip, width=4.5cm]{P50D30.eps}
  ...
  \begin{center}
    \begin{tabular}{c}
      ...
      \begin{minipage}{0.33\hsize}
        \begin{center}
          \includegraphics[clip, width=4.5cm]{P10D50.eps}
      ...
      \begin{minipage}{0.33\hsize}
        \begin{center}
          \includegraphics[clip, width=4.5cm]{P30D50.eps}
      ...
      \begin{minipage}{0.33\hsize}
        \begin{center}
          \includegraphics[clip, width=4.5cm]{P50D50.eps}
  ...
  \begin{center}
    \begin{tabular}{c}
      ...
      \begin{minipage}{0.33\hsize}
        \begin{center}
          \includegraphics[clip, width=4.5cm]{P10D100.eps}
      ...
      \begin{minipage}{0.33\hsize}
        \begin{center}
          \includegraphics[clip, width=4.5cm]{P30D100.eps}
      ...
      \begin{minipage}{0.33\hsize}
        \begin{center}
          \includegraphics[clip, width=4.5cm]{P50D100.eps}
...
\section{アーカイブ改善の提案}
\chapter{アーカイブの問題点}
アーカイブは集団の次元数や集団数によって
\chapter{提案手法1:アーカイブサイズの廃止}
アーカイブのサイズは集団Pと同じサイズだけとり，それをこえると，超過した分だけ，

\chapter{提案手法2:アーカイブ選択率の変更}
アーカイブは収束性
