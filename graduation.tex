...
\chapter{序論}
\section{研究の背景}
実数値最適化問題とは，あるD次元の実数値ベクトルとそれを評価する関数が与えられたときその評価関数を最小もしくは最大化するような関数を探す問題である．
多くの実問題においてその評価関数は多峰性や悪スケール性が高いなど，局所解に陥りやすく，局所解を脱し，大域的な最適解を見つけることがことが求められる．
それを可能にするする手法として差分進化法\（DifferentialEvolution\)が用いられる．
解ベクトルxをｎ個持つ解の集団を保持し
DEはDEは確率的手法の一つであり，生物の進化メカニズムをまね，変化と選択に基づく世代交代により，解が進化していく進化計算の一つで有る．
...
\section{関連研究}
差分進化の重要なアルゴリズムの一つとして適応型の差分進化手法としてJADEやSHADEなどがある．
このアルゴリズムではDEの性能を大きく左右するスケーリングパラメーターFや交叉率CRを適応的に変化させることで従来のDEより，高い性能をしめすことに成功している．
\section{研究の目的}
本研究の目的は２つある．
...
\section{差分進化}
\section{アーカイブと適応DE}
\cahpter{適応型DifferentialEvolutionとアーカイブ}
\section{}
