...
\chapter{終わりに}
\section{まとめ}
本論文では，解集団における重心からの距離の標準偏差と，目的関数値$f(\vector{x})$の標準偏差をしめすこれらの多様性評価指標$r_s$, $r_f$を用いて，アーカイブが解集団における多様性の維持に確かに貢献していること，また，．
アーカイブの性能を改善するためには，アーカイブを選択する確率を変えるよりも，アーカイブの取り方自体をかえることの方が有用であると思われることを知見として得ることができた．
